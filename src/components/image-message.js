        ...
        <div className='container mx-auto py-10 px-4'>
            <div className='md:flex items-center'>
                <div className="md:w-4/7">
                    <h3 className='font-semibold text-3xl leading-snug'>Tu contenido es importante, es reflejo de
                        tu trabajo.</h3>
                    <p className='text-sm py-6'>Valoramos el contenido de calidad, por eso en Arquitect.io
                        seleccionaremos el mejor contenido para mostrarlo al mayor número de personas posible.</p>
                </div>
